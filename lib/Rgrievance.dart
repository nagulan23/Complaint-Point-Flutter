...
class Rgrievance extends StatefulWidget {
  @override
  RgrievanceState createState() => RgrievanceState();
}

class RgrievanceState extends State<Rgrievance>{
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
        appBar: AppBar(
        title: Text("Reported Grievance", style: TextStyle(color: Colors.white)),
