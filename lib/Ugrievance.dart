...
class Ugrievance extends StatefulWidget {
  @override
  UgrievanceState createState() => UgrievanceState();
}

class UgrievanceState extends State<Ugrievance>{
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
        appBar: AppBar(
        title: Text("Upvoted Grievance", style: TextStyle(color: Colors.white)),
